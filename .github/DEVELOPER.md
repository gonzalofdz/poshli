...
Please read [SECURITY.md](https://github.com/gonzalofdz/poshli/blob/master/.github/SECURITY.md).  Security is fundamental in the code of this project, otherwise this project would not make sense.
